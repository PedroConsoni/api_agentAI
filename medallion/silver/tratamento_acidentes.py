...
df = pd.read_csv('medallion/bronze/acidentes2025.csv', encoding='LATIN1', sep=';')
print("Arquivo 'acidentes2025.csv' carregado com sucesso.")
...
colunas_categoricas = [
    ...
    'tipo_veiculo', 'marca', 'tipo_envolvido', 
    'estado_fisico', 'sexo'
]
...
print("\n2/3: Tratando colunas de contagem e idade...")
...
df.to_csv('acidentes2025_tratado.csv', encoding='LATIN1', index=False, sep=';')