...
Este projeto implementa um pipeline completo de ETL (Extract, Transform, Load) utilizando dados públicos da Polícia Rodoviária Federal (PRF), finalizando com a criação de um agente de Inteligência Artificial capaz de responder perguntas sobre os dados armazenados.
Além disso, gráficos e análises são gerados automaticamente com base nas informações já tratadas.
...
Após a transformação, os dados foram carregados para um banco SQLite, permitindo consultas rápidas e fáceis diretamente em um arquivo local .db.
...
Utilizei bibliotecas como matplotlib ou seaborn para as visualizações.
...
Criar um fluxo completo que demonstre práticas de engenharia de dados, análise e inteligência artificial, tudo baseado em dados reais e utilizando uma abordagem didática e bem estruturada.
